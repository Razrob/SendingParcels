...
public class AutoEarnings : MonoBehaviour
{
    private BusinessWindowDisplay businessController;
    ...
    public void SortCentersWork(int passedSeconds)
    {
        ...
        if (businessController == null) businessController = FindObjectOfType<BusinessWindowDisplay>();
